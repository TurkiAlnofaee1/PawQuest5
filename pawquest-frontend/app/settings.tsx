    ...
    <ImageBackground source={bgImage} style={styles.bg} resizeMode="cover">
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.list}>
          <TouchableOpacity style={styles.card} activeOpacity={0.8} onPress={() => router.push('/account')}>
            <Text style={styles.cardText}>Account</Text>
            <MaterialCommunityIcons name="chevron-right" size={22} color="#2c3029" />
          </TouchableOpacity>

          <TouchableOpacity style={styles.card} activeOpacity={0.8} onPress={() => router.push('/notifications')}>
            <Text style={styles.cardText}>Notifications</Text>
            <MaterialCommunityIcons name="chevron-right" size={22} color="#2c3029" />
          </TouchableOpacity>

          <TouchableOpacity style={styles.card} activeOpacity={0.8} onPress={() => router.push('/experience-new')}>
            <Text style={styles.cardText}>Create an experiance  +</Text>
            <MaterialCommunityIcons name="chevron-right" size={22} color="#2c3029" />
          </TouchableOpacity>
        </View>
      </SafeAreaView>
